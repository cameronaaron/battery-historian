...
const (
	...
	// Updated to support Android 16 (API 36) - maxParseReportVersion bumped to 26
	minParseReportVersion = 11
	maxParseReportVersion = 26
)
...
const (
	...
	videoData                   = "vid"
	audioData                   = "aud"
	// Android 12+ (API 31+) battery stats fields
	batteryHealthData            = "bh"    // Battery health including state of health
	batteryChargeCounterData     = "bcc"   // Battery charge counter
	batteryCurrentData           = "bcur"  // Battery current (mA)
	batteryTemperatureData       = "btemp" // Battery temperature
	stateOfHealthData            = "soh"   // State of health percentage
	batteryManufacturingDateData = "bmd"   // Battery manufacturing date
	batteryFullChargeDesignData  = "bfcd"  // Full charge design capacity
	chargingPolicyData           = "chp"   // Charging policy (normal, adaptive, etc.)
	thermalStatusData            = "ths"   // Thermal status
	modemRailPowerData           = "mrpd"  // Modem rail power data (Android 14+)
	wifiRailPowerData            = "wrpd"  // WiFi rail power data (Android 14+)
	cpuRailPowerData             = "crpd"  // CPU rail power data (Android 14+)
	gpuRailPowerData             = "grpd"  // GPU rail power data (Android 14+)
	systemRailPowerData          = "srpd"  // System rail power data (Android 14+)
)
